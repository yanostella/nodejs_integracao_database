import { makeFindAdressByPersonUseCase } from '@/use-cases/factory/make-find-adress-by-person-use-case';
import { FastifyReply, FastifyRequest } from 'fastify';
import { z } from 'zod';

export async function findAdress(request: FastifyRequest, reply: FastifyReply) {
